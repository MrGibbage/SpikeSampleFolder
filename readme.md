If you want to use python on the Lego Spike Prime controller with VS Code as your editor, you can use these dummy files to give the intellisense hints for code completion.
